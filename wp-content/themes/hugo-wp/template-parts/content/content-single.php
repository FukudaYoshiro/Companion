<div id="post-<?php the_ID(); ?>"<?php post_class(); ?>>
    ...
    <div class="post-content-single">
        ...
        <div class="post-content-inner">
			...
			wp_link_pages( array(
				...
				'link_before' => '<span>',
				'link_after'  => '</span>',
				'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'hugo-wp' )
				                 . ' </span>%',
	...
	the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Next:', 'hugo-wp' )
		               . '</span> ' .
		               '<span class="screen-reader-text">' . esc_html__( 'Next post:', 'hugo-wp' ) . '</span> ' .
		...
		'prev_text' => '<i class="font-icon-post fa fa-angle-double-left"></i>' .
		               '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Previous:', 'hugo-wp' )
		               . '</span> ' .
		               '<span class="screen-reader-text">' . esc_html__( 'Previous post:', 'hugo-wp' )
		               . '</span> ' .
